...
- **Three display styles** — the **Split-flap** (Solari) board, a **digital LED** 14-segment alphanumeric display (5 colors), or a **Pixel** display using Vercel's Geist Pixel font (Square / Grid / Line variants, each with a matching pixel/scanline backdrop and a toggleable CSS-and-SVG **CRT overlay** — scanlines, chromatic aberration, flicker and vignette)
